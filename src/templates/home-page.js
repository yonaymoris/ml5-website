      ...
      >
        ...
        >
          <p style={{ marginBottom: '1rem' }}>
            Breonna Taylor, George Floyd, Ahmaud Arbery, Tony McDade, Regis
            Korchinski-Paquet, Nina Pop, Monika Diamond, Yassin Mohamed, Finan
            H. Berhe, Sean Reed, Steven Demarco Taylor, Sandra Bland, David
            McAtee, Ariane McCree, Terrance Franklin, Miles Hall, Darius Tarver,
            William Green, Samuel David Mallard, Kwame Jones, De’von Bailey,
            Christopher Whitfield, Anthony Hill, De’Von Bailey, Eric Logan,
            ...
            Ramarley Graham, Manuel Loggins Jr, Trayvon Martin, Wendell Allen,
            Kendrec McDade, Larry Jackson Jr, Jonathan Ferrell, Jordan Baker,
            ...
            McDonald, Akai Gurley, Tamir Rice, Rumain Brisbon, Jerame Reid,
            Charly Keunang, Tony Robinson, Walter Scott, Freddie Gray, Brendon
            Glenn, Samuel DuBose, Christian Taylor, Jamar Clark, Mario Woods,
            Quintonio LeGrier, Gregory Gunn, Akiel Denkins, Alton Sterling,
            Philando Castile, Terrence Sterling, Terence Crutcher, Keith Lamont
            Scott, Alfred Olango, Jordan Edwards, Stephon Clark, Danny Ray
        ...
        <p style={{ marginBottom: '1rem' }}>
          ...
          <a href="https://bailfunds.github.io/">your local bail fund</a>,&nbsp;
          <a href="https://codecooperative.org/">Code Cooperative</a>,&nbsp;
          <a href="https://emergencyreleasefund.com/">Emergency Release Fund</a>
          ,&nbsp;
          <a href="https://spny.wedid.it/campaigns/7636/contribute">
            Survived & Punished Mutual Aid Fund
          </a>
          ,&nbsp;
          <a href="https://www.gofundme.com/f/9v4q2-justice-for-breonna-taylor">
        ...
        <button
          ...
          onClick={handleClose}
        >
          <span aria-label="solidarity fist" role="img">
            ✊🏿
          </span>
          No Justice, No Peace
        </button>
