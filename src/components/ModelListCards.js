    ...
    <section id={`section-${tag}`}>
      ...
      <ul className="ModelList">
        {selected.map(({ node: model }) => (
          ...
          >
            <div
              style={{ border: 'none', padding: '0.5rem', borderRadius: '2px' }}
            >
              <div
                className="ModelList__title"
                style={{ fontWeight: 'bold', fontSize: 20, padding: '0' }}
              >
                <Link
...
class ModelListCards extends React.Component {
  render() {
    ...
    return (
      <div>
        <p>
          Welcome to the ml5.js reference page! Here you can browse the various
          categories of functionality that ml5.js provides. We have categorized
          the functionality of ml5.js based on the types of input and output
          that you might be interested to work with.
        </p>
        <h3>
          ...
          >
            <a style={aTagRefStyle} href="#section-image">
              Image
            </a>
            <a style={aTagRefStyle} href="#section-sound">
              Sound
            </a>
            <a style={aTagRefStyle} href="#section-text">
              Text
            </a>
            <a style={aTagRefStyle} href="#section-helpers">
              Helpers
            </a>
          </ul>
        </h3>
